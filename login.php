...
<body>
    <div class="container">
        ...
        <div class="cover">
            <div class="front">
                <img src="img/communityIcon_olk9f7nto6891.jpg" alt="">
                <div class="text">

                </div>
            </div>
            <div class="back">
                <img class="backImg" src="img/image.png" alt="">
                <div class="text">
        ...
        <div class="forms">
            <div class="form-content">
                ...
                <div class="signup-form">
                    ...
                    <form action="log&sign.php" method="post">
                        <div class="input-boxes">
                            <div class="input-box">
